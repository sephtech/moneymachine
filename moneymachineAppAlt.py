...
class mainFrame(FloatLayout):
    ...
    def getData(self):
        ...
        if self.ids.coin1.text != '':
            data_coin1 = calc.getGraphAbsoluteData(self.ids.coin1.text)
            self.time_coin1_day = []
            self.time_coin1_day.append(data_coin1[0])
            self.time_coin1_week = []
            self.time_coin1_week.append(data_coin1[2])
            self.time_coin1_month = []
            self.time_coin1_month.append(data_coin1[4])
            self.time_coin1_year = []
            self.time_coin1_year.append(data_coin1[6])
            self.data_coin1_day = []
            self.data_coin1_day.append(data_coin1[1])
            self.data_coin1_week = []
            self.data_coin1_week.append(data_coin1[3])
            self.data_coin1_month = []
            self.data_coin1_month.append(data_coin1[5])
            self.data_coin1_year = []
            self.data_coin1_year.append(data_coin1[7])
            self.coin1_read = True
        else:
            self.coin1_read = False

        if self.ids.coin2.text != '':
            data_coin2 = calc.getGraphAbsoluteData(self.ids.coin2.text)
            self.time_coin2_day = []
            self.time_coin2_day = []
            self.time_coin2_day.append(data_coin2[0])
            self.time_coin2_week = []
            self.time_coin2_week.append(data_coin2[2])
            self.time_coin2_month = []
            self.time_coin2_month.append(data_coin2[4])
            self.time_coin2_year = []
            self.time_coin2_year.append(data_coin2[6])
            self.data_coin2_day = []
            self.data_coin2_day.append(data_coin2[1])
            self.data_coin2_week = []
            self.data_coin2_week.append(data_coin2[3])
            self.data_coin2_month = []
            self.data_coin2_month.append(data_coin2[5])
            self.data_coin2_year = []
            self.data_coin2_year.append(data_coin2[7])
            self.coin2_read = True
        else:
            self.coin2_read = False

        if self.ids.coin3.text != '':
            data_coin3 = calc.getGraphAbsoluteData(self.ids.coin3.text)
            self.time_coin3_day = []
            self.time_coin3_day = []
            self.time_coin3_day.append(data_coin3[0])
            self.time_coin3_week = []
            self.time_coin3_week.append(data_coin3[2])
            self.time_coin3_month = []
            self.time_coin3_month.append(data_coin3[4])
            self.time_coin3_year = []
            self.time_coin3_year.append(data_coin3[6])
            self.data_coin3_day = []
            self.data_coin3_day.append(data_coin3[1])
            self.data_coin3_week = []
            self.data_coin3_week.append(data_coin3[3])
            self.data_coin3_month = []
            self.data_coin3_month.append(data_coin3[5])
            self.data_coin3_year = []
            self.data_coin3_year.append(data_coin3[7])
    ...
    def updateGraph(self):
        ...
        for c in range(0,2):
            # create data
            if (c == 0 and coin1 != '') or (c == 1 and coin2 != '') or (c == 2 and coin3 != ''):
                print("coin ", c)
